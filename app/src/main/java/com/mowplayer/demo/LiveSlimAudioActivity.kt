...
import kotlinx.android.synthetic.main.activity_live_slim_audio.*

class LiveSlimAudioActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_live_slim_audio)
